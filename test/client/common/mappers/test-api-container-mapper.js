...
describe('api-container-mapper.js', function() {
    ...
    describe('#mapSingle', function() {
        ...
        it('should map fields of a Core API container entity', function() {
            ...
            assert.equal(mappedContainerObject.image.id, singleApiContainer.image, "image property should be mapped to image.id")
    ...
    describe('#mapMany', function() {
        ...
        it('should map fields of several Core API container entities in an Array', function() {
            ...
            assert.equal(mappedContainersArray[0].image.id, fakeData.twoApiContainers[0].image, "first entity's image property should be mapped to image.id")
            ...
            assert.equal(mappedContainersArray[1].image.id, fakeData.twoApiContainers[1].image, "second entity's image property should be mapped to image.id")
