    ...
    switch (action.type){
        ...
        case FETCH_CONTAINERS_SUCCESS:
            return state.withMutations((state) => {
                ...
                state.set('containers', List.of(action.containers))
            })
        ...
        case BUILD_CONTAINER_STARTED:
            return state.updateIn(['containers'], list => list.push(6))
    /*
        ...
        case BUILD_CONTAINER_ERROR:
            return state.set('fail', true)
            
        //Start container actions
