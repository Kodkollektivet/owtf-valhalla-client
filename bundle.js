...
/***/ function(module, exports, __webpack_require__) {
	...
	var unsubscribe = store.subscribe(function () {
	    return printState(store.getState());
	});

	function printState(state) {
	    //console.log(state.log.entries)
	    for (var i = 0; i < state.log.entries.length; i++) {
	        console.log(state.log.entries[i]);
	    }
	}

	// Dispatch some actions
	store.dispatch((0, _actions.logInfo)('Info...'));
	store.dispatch((0, _actions.logWarn)('Warning!!'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fetchContainersReducer = __webpack_require__(306);

	var _fetchContainersReducer2 = _interopRequireDefault(_fetchContainersReducer);

	var _logReducer = __webpack_require__(310);
	...
	var reducers = (0, _redux.combineReducers)({
	  ...
	  containerList: _fetchContainersReducer2.default
	});

	function configureStore(initialState) {
	  var store = (0, _redux.createStore)(reducers, initialState, (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default)));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPrototype = __webpack_require__(297),
	    isHostObject = __webpack_require__(298),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _coreApiService = __webpack_require__(307);

	var _coreApiService2 = _interopRequireDefault(_coreApiService);
	...
	'use-strict';
	var fetchContainersReducer = function fetchContainersReducer() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialState : arguments[0];
	    var action = arguments[1];


	    switch (action) {
	        case _actionTypes.FETCH_CONTAINERS_REQUEST:
	            return function (dispatch) {
	                dispatch((0, _actions.fetchContainersStarted)());

	                _coreApiService2.default.getContainers().then(function (containers) {
	                    return dispatch((0, _actions.fetchContainersSuccess)(containers));
	                }).catch(function (error) {
	                    return dispatch((0, _actions.fetchContainersFailure)(error));
	                });
	            };

	        case _actionTypes.FETCH_CONTAINERS_STARTED:
	            return Object.Assign({}, state, { fetching: true });

	        case _actionTypes.FETCH_CONTAINERS_SUCCESS:
	            return Object.Assign({}, state, { fetching: false, ready: true, containers: action.containers });

	        case _actionTypes.FETCH_CONTAINERS_ERROR:
	            return function (dispatch) {
	                dispatch((0, _actions.logError)('Could not fetch containers from core API.', action.error));
	            };
	    }
	...
	exports.default = fetchContainersReducer;
...
/***/ function(module, exports) {
	...
	var FETCH_CONTAINERS_REQUEST = exports.FETCH_CONTAINERS_REQUEST = 'FETCH_CONTAINERS_REQUEST';
	var FETCH_CONTAINERS_STARTED = exports.FETCH_CONTAINERS_STARTED = 'FETCH_CONTAINERS_STARTED';
	var FETCH_CONTAINERS_SUCCESS = exports.FETCH_CONTAINERS_SUCCESS = 'FETCH_CONTAINERS_SUCCESS';
	var FETCH_CONTAINERS_FAILURE = exports.FETCH_CONTAINERS_FAILURE = 'FETCH_CONTAINERS_FAILURE';

	//Start container async API call actions
	var START_CONTAINER_REQUEST = exports.START_CONTAINER_REQUEST = 'START_CONTAINER_REQUEST';
	var START_CONTAINERS_STARTED = exports.START_CONTAINERS_STARTED = 'START_CONTAINERS_STARTED';
	var START_CONTAINER_SUCCESS = exports.START_CONTAINER_SUCCESS = 'START_CONTAINER_SUCCESS';
	var START_CONTAINER_FAILURE = exports.START_CONTAINER_FAILURE = 'START_CONTAINER_FAILURE';

	//Start container async API call actions
	var STOP_CONTAINER_REQUEST = exports.STOP_CONTAINER_REQUEST = 'STOP_CONTAINER_REQUEST';
	var STOP_CONTAINER_SUCCESS = exports.STOP_CONTAINER_SUCCESS = 'STOP_CONTAINER_SUCCESS';
	var STOP_CONTAINER_FAILURE = exports.STOP_CONTAINER_FAILURE = 'STOP_CONTAINER_FAILURE';

	//Log actions
	var LOG_INFO = exports.LOG_INFO = 'LOG_INFO';
	var LOG_WARN = exports.LOG_WARN = 'LOG_WARN';
	var LOG_ERROR = exports.LOG_ERROR = 'LOG_ERROR';
	var LOG_CRITICAL = exports.LOG_CRITICAL = 'LOG_CRITICAL';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.fetchContainersRequest = fetchContainersRequest;
	exports.fetchContainersStarted = fetchContainersStarted;
	exports.fetchContainersSuccess = fetchContainersSuccess;
	exports.fetchContainersFailure = fetchContainersFailure;
	...
	function fetchContainersRequest() {
	  return { type: _actionTypes.FETCH_CONTAINERS_REQUEST };
	}

	function fetchContainersStarted() {
	  return { type: _actionTypes.FETCH_CONTAINERS_STARTED };
	}

	function fetchContainersSuccess(containers) {
	  return { type: _actionTypes.FETCH_CONTAINERS_SUCCESS, containers: containers };
	}

	function fetchContainersFailure(error) {
	  return { type: _actionTypes.FETCH_CONTAINERS_FAILURE, error: error };
	}

	//Log action creators
	function logInfo(message, inner) {
	  return { type: _actionTypes.LOG_INFO, message: message, inner: inner };
	}

	function logWarn(message, inner) {
	  return { type: _actionTypes.LOG_WARN, message: message, inner: inner };
	}

	function logError(message, inner) {
	  return { type: _actionTypes.LOG_ERROR, message: message, inner: inner };
	}

	function logCritical(message, inner) {
	  return { type: _actionTypes.LOG_CRITICAL, message: message, inner: inner };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialState = {
	    focusEntry: null,
	    entries: [{ level: _level.info, message: 'Welcome to admin gui for OWTF Valhalla.', inner: '' }]
	};
	...
	var logReducer = function logReducer() {
	    ...
	    switch (action.type) {
	        case _actionTypes.LOG_INFO:
	            return Object.Assign({}, state, { entries: [].concat(_toConsumableArray(state.entries), [{ level: _level.info, message: action.message, inner: action.inner }]) });

	        case _actionTypes.LOG_WARN:
	            return Object.Assign({}, state, { entries: [].concat(_toConsumableArray(state.entries), [{ level: _level.warn, message: action.message, inner: action.inner }]) });

	        case _actionTypes.LOG_ERROR:
	            return Object.Assign({}, state, { entries: [].concat(_toConsumableArray(state.entries), [{ level: _level.error, message: action.message, inner: action.inner }]) });

	        case _actionTypes.LOG_CRITICAL:
	            return Object.Assign({}, state, { entries: [].concat(_toConsumableArray(state.entries), [{ level: _level.critical, message: action.message, inner: action.inner }]) });
